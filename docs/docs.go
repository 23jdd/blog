...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.CreateArticleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.CreateArticleResponse"
                        }
                    },
                    "400": {
        ...
        "/articles/comments/{commentID}/status": {
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.ReviewStatusRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.UpdateArticleRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.LikeActionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.UpdateArticleStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/logout": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "可选，携带 refresh_token 用于同步撤销",
                        "name": "req",
                        "in": "body",
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.DynamicConfigRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.DraftSaveRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.Article": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "draft/published/offline",
                    "type": "string"
                },
                "tags": {
                    "description": "标签，逗号分隔",
        ...
        "types.CreateArticleRequest": {
            ...
            "properties": {
                ...
                "content": {
                    "description": "兼容旧字段，等价于 content_url",
                    "type": "string"
                },
                "content_url": {
                    "description": "markdown 文件 URL",
                    "type": "string"
                },
                "cover_url": {
                    "description": "封面图URL",
        ...
        "types.UpdateArticleStatusRequest": {
            "type": "object",
            "properties": {
                "status": {
                    "description": "draft/published/offline",
